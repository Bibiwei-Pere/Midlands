...
import { ManageAffiliateCol } from "@/app/components/schema/Columns";
...
import { useGetAllPayout } from "@/hooks/payout";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent } from "@/components/ui/dropdown-menu";
import { FaFilter } from "react-icons/fa";
import { FaChevronDown, FaChevronUp } from "react-icons/fa6";

const AdminAffiliate = ({ hide }: any) => {
  ...
  const { data: payouts } = useGetAllPayout();
          ...
          <div className='relative'>
            <div className='max-w-full'>
              <DashboardHeader className='z-1 top-0 pt-5 pb-10'>
                <h4>{hide !== "true" ? "Withdrawal Requests" : "History"}</h4>
                <Input
