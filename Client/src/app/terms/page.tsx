...
const TermsOfUse = () => {
  return (
    <div className='container mx-auto p-6'>
      <h2 className='text-4xl text-yellow-500 font-bold mb-4'>Terms of Use</h2>
      <p className='mb-4'>
        Welcome to <strong>mywebsite</strong>, your guide to Forex success through structured learning and a supportive
        community. By using our platform, you agree to comply with and be bound by the following terms and conditions.
        Please review them carefully.
      </p>

      <h2 className='text-2xl font-semibold mt-8 mb-2'>1. Acceptance of Terms</h2>
      <p className='mb-4'>
        By accessing and using the mywebsite platform, you agree to be bound by these Terms of Use and our Privacy
      ...
      <p className='mb-4'>
        mywebsite provides educational resources, analytics, and community support for forex trading. You agree to use
        the platform only for lawful purposes and in compliance with all applicable laws.
      </p>
      ...
      <p className='mb-4'>
        All content on mywebsite, including but not limited to text, graphics, logos, and software, is the property of
        mywebsite or its content suppliers. You may not copy, modify, distribute, or sell any content without express
        permission.
      </p>

      <h2 className='text-2xl font-semibold mt-8 mb-2'>5. Limitation of Liability</h2>
      <p className='mb-4'>
        mywebsite shall not be liable for any direct, indirect, incidental, or consequential damages arising out of your
      ...
      <p className='mb-4'>
        mywebsite reserves the right to update or modify these Terms of Use at any time. We will notify users of
